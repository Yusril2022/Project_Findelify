...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Menyembunyikan sidebar secara default saat halaman dimuat
    sidebar.classList.add('hide');

    // Sidebar terbuka ketika kursor masuk ke sidebar
    sidebar.addEventListener('mouseover', function() {
        sidebar.classList.remove('hide'); // Menghapus kelas 'hide', sehingga sidebar terbuka
    });

    // Sidebar tertutup ketika kursor keluar dari sidebar
    sidebar.addEventListener('mouseout', function() {
        sidebar.classList.add('hide'); // Menambahkan kelas 'hide', sehingga sidebar tertutup
    });

    // Menangani klik pada item sidebar untuk menambahkan kelas 'active'
    const allSideMenu = document.querySelectorAll('#sidebar .side-menu.top li a');
    allSideMenu.forEach(item => {
        const li = item.parentElement;
